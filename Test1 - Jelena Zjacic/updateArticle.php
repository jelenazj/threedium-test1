...
<div>
	<div class = "container">
		...
		<h3><small>Writen by </small>$user</h3>
		<p><i> $date</i> </p>
		</div>
		<div>
		<form action="updateArticleinDB.php" method="post">
		<!--<textarea class="col-sm-9" style="height: 500px;">$text</textarea>-->
		<input type="hidden" name="articleid" value="{$articleid}">
		<input style="width: auto;" type="text" name="articletext" value="{$text}">
